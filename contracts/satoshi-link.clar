...
;; Initialize bridge (only deployer)
...
;; Pause bridge operations (only deployer)
...
;; Initiate a Bitcoin deposit (validator-only)
...
;; Withdraw from bridge to a Bitcoin address
...
;; Emergency withdraw (deployer-only)
